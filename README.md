...
- 🔬 **PubMed連携**: 高精度PMID検索（5段階検索戦略）とPubMedリンク生成
...
4. **PubMed検索**: 5段階検索戦略による高精度PMID検索
   - 短縮タイトル + 著者 + 年
   - 緩い条件検索（年なし）
   - 部分タイトル + 主要著者 + 年
   - 完全タイトル + 複数著者 + 年
...
7. **データ投稿**: Notionデータベースにページ作成
8. **ファイル移動**: 処理済みPDFを`processed_pdfs`フォルダに自動移動・整理
...
### 高精度PubMed検索システム
- **5段階検索戦略**: 確実性の高い順序でPMID検索を実行
- **動的タイトル短縮**: 長いタイトルでも確実に検索
- **複数著者対応**: 上位5人の著者で順次検索
- **キーワード抽出**: ストップワード除去による高精度検索
